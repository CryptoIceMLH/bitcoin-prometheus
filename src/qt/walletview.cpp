      ...
      platformStyle(_platformStyle)
{
    ...
    dashboardPage = new DashboardPage(platformStyle);
    sovereignControlsPage = new SovereignControlsPage(platformStyle);
    ...
    addWidget(sovereignControlsPage);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    sovereignControlsPage->setClientModel(_clientModel);
...
void WalletView::gotoSovereignControlsPage()
{
    setCurrentWidget(sovereignControlsPage);
}
