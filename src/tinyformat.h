...
#include <algorithm>
#include <attributes.h> // Added for BTC-Prometheus
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for BTC-Prometheus
#include <util/string.h> // Added for BTC-Prometheus
...
// Added for BTC-Prometheus. Similar to std::runtime_format from C++26.
...
// Added for BTC-Prometheus. Wrapper for checking format strings at compile time.
