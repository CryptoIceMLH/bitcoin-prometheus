...
We aim to cut a regular release every 3-4 months, approximately twice as frequent as major BTC-Prometheus releases. Every second release should be published one month before the feature freeze of the next major BTC-Prometheus release, allowing sufficient time to update the library in Core.
