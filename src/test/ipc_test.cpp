// Copyright (c) 2023 The BTC-Prometheus developers
...
void IpcSocketTest(const fs::path& datadir)
{
    ...
    //   Address 'unix' path '"/tmp/test_common_BTC-Prometheus/ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff/test_bitcoin.sock"' exceeded maximum socket path length
