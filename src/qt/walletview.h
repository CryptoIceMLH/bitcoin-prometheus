// Copyright (c) 2011-2021 The BTC-Prometheus developers
...
private:
    ...
    SovereignControlsPage *sovereignControlsPage;
...
public Q_SLOTS:
    ...
    /** Switch to sovereign controls page */
    void gotoSovereignControlsPage();
