// Copyright (c) 2012-2022 The BTC-Prometheus developers
...
{
    BOOST_CHECK(TestSplitHost("example.com", "example.com", 0));
    BOOST_CHECK(TestSplitHost("[example.com]", "example.com", 0));
    BOOST_CHECK(TestSplitHost("example.com:80", "example.com", 80));
    BOOST_CHECK(TestSplitHost("[example.com]:80", "example.com", 80));
    ...
    BOOST_CHECK(TestSplitHost("example.com:65536", "example.com:65536", 0, false));
    BOOST_CHECK(TestSplitHost("example.com:0", "example.com", 0, false));
    BOOST_CHECK(TestSplitHost("example.com:", "example.com:", 0, false));
}
