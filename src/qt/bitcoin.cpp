// Copyright (c) 2011-2022 The BTC-Prometheus developers
...
int GuiMain(int argc, char* argv[])
{
    ...
    // Apply Prometheus fire & darkness theme
    app.setStyleSheet(
        "QMainWindow, QDialog, QWidget { background-color: #1a1a1a; color: #e6e6e6; }"
        "QMenuBar { background-color: #262626; color: #e6e6e6; border-bottom: 1px solid #FF8C00; }"
        "QMenuBar::item:selected { background-color: #FF8C00; color: #1a1a1a; }"
        "QMenu { background-color: #262626; color: #e6e6e6; border: 1px solid #444; }"
        "QMenu::item:selected { background-color: #FF8C00; color: #1a1a1a; }"
        "QToolBar { background-color: #262626; border: none; border-bottom: 1px solid #444; spacing: 6px; }"
        "QToolButton { color: #e6e6e6; padding: 6px; border-radius: 4px; }"
        "QToolButton:hover { background-color: #FF8C00; color: #1a1a1a; }"
        "QToolButton:checked { background-color: #FF4500; color: #fff; }"
        "QStatusBar { background-color: #262626; color: #a0a0a0; border-top: 1px solid #444; }"
        "QTabWidget::pane { border: 1px solid #444; background-color: #1a1a1a; }"
        "QTabBar::tab { background-color: #262626; color: #a0a0a0; padding: 8px 16px; border: 1px solid #444; }"
        "QTabBar::tab:selected { background-color: #1a1a1a; color: #FF8C00; border-bottom: 2px solid #FF8C00; }"
        "QTabBar::tab:hover { color: #FFBF00; }"
        "QPushButton { background-color: #FF8C00; color: #1a1a1a; border: none; padding: 8px 16px; border-radius: 4px; font-weight: bold; }"
        ...
        "  background-color: #2a2a2a; color: #e6e6e6; border: 1px solid #555; border-radius: 4px; padding: 4px;"
        "}"
        "QLineEdit:focus, QTextEdit:focus, QPlainTextEdit:focus {"
        "  border: 1px solid #FF8C00;"
        "}"
        "QTableView, QTreeView, QListView {"
        "  background-color: #1e1e1e; color: #e6e6e6; gridline-color: #333;"
        "  selection-background-color: #FF8C00; selection-color: #1a1a1a;"
        "  alternate-background-color: #222;"
        "}"
        "QHeaderView::section { background-color: #262626; color: #FF8C00; border: 1px solid #444; padding: 4px; }"
        ...
        "QScrollBar:horizontal { background-color: #1a1a1a; height: 12px; }"
        ...
        "QProgressBar { background-color: #2a2a2a; border: 1px solid #555; border-radius: 7px; padding: 1px; text-align: center; color: #e6e6e6; }"
        "QProgressBar::chunk { background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #FF4500, stop:0.5 #FF8C00, stop:1 #FFBF00); border-radius: 7px; }"
        "QGroupBox { border: 1px solid #444; border-radius: 4px; margin-top: 8px; padding-top: 16px; color: #FF8C00; }"
        "QGroupBox::title { subcontrol-origin: margin; left: 10px; padding: 0 5px; color: #FF8C00; }"
        "QCheckBox, QRadioButton { color: #e6e6e6; }"
        "QCheckBox::indicator:checked { background-color: #FF8C00; border: 1px solid #FF8C00; }"
        "QLabel { color: #e6e6e6; }"
        "QToolTip { background-color: #333; color: #FFBF00; border: 1px solid #FF8C00; padding: 4px; }"
    ...
    /// 6-7. Parse prometheus.conf, determine network, switch to network specific
