 ...
 * for both prometheusd and prometheus-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Prometheus");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/CryptoIceMLH/bitcoin-prometheus>";
