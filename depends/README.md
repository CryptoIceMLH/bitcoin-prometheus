...
**When configuring BTC-Prometheus, CMake by default will ignore the depends output.** In
...
created. To use it during configuring BTC-Prometheus:
...
variables will be set when generating the BTC-Prometheus buildsystem. In this case, `-DENABLE_WALLET=OFF`.
